...
@Component({
  selector: 'app-oncall-bill-pack',
  templateUrl: './oncall-bill-pack.component.html',
  styleUrls: ['./oncall-bill-pack.component.css']
})
export class OncallBillPackComponent implements OnInit {
