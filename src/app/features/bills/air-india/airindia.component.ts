...
import {BILL_API, BILL_UPDATE_K, OWNER_API, PARTY_HEAD_API} from '../../../../shared/services/api.url-helper';
  ...
  constructor(private router: Router,private apiService: ApiService, public dialog: MatDialog, private toastr: ToastrService) {
   ...
   saverecord(){
    this.billdetails.body.forEach(element =>{
      element.approvedkm = element.vendorkm;
    });
    this.apiService.post(BILL_UPDATE_K, this.billdetails.body).then((res: any)=>{ 
      debugger;
